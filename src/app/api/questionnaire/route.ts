...
export async function POST(req: NextRequest) {
  console.log('[debug] NEXT_PUBLIC_SUPABASE_URL:', process.env.NEXT_PUBLIC_SUPABASE_URL?.slice(0, 20))
  console.log('[debug] SERVICE_KEY exists:', !!process.env.SUPABASE_SERVICE_ROLE_KEY)
  console.log('[debug] ANON_KEY exists:', !!process.env.NEXT_PUBLIC_SUPABASE_ANON_KEY)
